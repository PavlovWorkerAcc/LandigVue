...
<template>
  <header>
    ...
    <div class="media_container">
      ...
      <button @click="openMediaNav"  class="hamburger hamburger--collapse" type="button">
...
@media screen and (max-width: 890px){
  ...
  .glass_logo_form_header , .form_header_input {
    display: none;
  }
